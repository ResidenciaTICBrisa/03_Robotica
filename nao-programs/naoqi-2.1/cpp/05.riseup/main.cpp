...
int main(int argc, char **argv)
{
	...
	session->registerService(RiseUp::moduleName,
		qi::AnyObject(boost::make_shared<RiseUp>(broker)));

	qi::AnyObject riseUpModule = session->service(RiseUp::moduleName);

	riseUpModule.call<void>("wakeUp");
