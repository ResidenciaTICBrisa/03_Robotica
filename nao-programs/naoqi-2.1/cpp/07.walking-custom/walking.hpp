...
class Walking {
	...
	private:
		...
		static const std::string initialPosture;
		static const std::string initialPostureFamily;
		...
		eventCallbackPtr goToPostureAndCheck(
			const std::string targetPosture,
			const std::string targetPostureType,
			const float speed,
			eventCallbackPtr postureReachedState,
			eventCallbackPtr postureApproachedState,
			eventCallbackPtr postureFailedState);
		...
		void moveToSlowly(float x, float y, float z);
